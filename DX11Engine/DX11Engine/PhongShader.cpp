...
bool PhongShader::initialize(ID3D11Device* device, ID3D11DeviceContext* context)
{
...
void PhongShader::SetParametersAndRender(ID3D11DeviceContext* context, Model* model, const D3DXMATRIX& m, const D3DXMATRIX& v, const D3DXMATRIX& p, Texture* tex)
{
	mvp.model = m;
	mvp.view = v;
	mvp.projection = p;
